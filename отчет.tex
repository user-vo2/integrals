...
% закрашиваем фигуру
\addplot[blue!20,samples=256] fill between[of=A and B,soft clip={domain=-1.830069:-0.298327}];
\addplot[blue!20,samples=256] fill between[of=A and C,soft clip={domain=-4.041704:-1.830069}];
\addlegendentry{$S=3.829575$}

% Поскольку автоматическое вычисление точек пересечения кривых в TiKZ реализовать сложно,
% будем явно задавать координаты.
\addplot[dashed] coordinates { (-4.041704, 2.027795) (-4.041704, 0) };
\addplot[color=black] coordinates {(-4.041704, 0)} node [label={-90:{\small -4.041704}}]{};

\addplot[dashed] coordinates { (-1.830069, 0.546427) (-1.830069, 0) };
\addplot[color=black] coordinates {(-1.830069, 0)} node [label={-90:{\small -1.830069}}]{};

\addplot[dashed] coordinates { (-0.298327, 3.347602) (-0.298327, 0) };
\addplot[color=black] coordinates {(-0.298327, 0)} node [label={-90:{\small -0.298327}}]{};
...
Тестирование и отладка производилачь при помощи опции командной строки  \textit{-test}.
